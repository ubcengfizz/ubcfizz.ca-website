    ...
    render() {
        return (
            <PageTemplate shortTitle="Executives" fullTitle="Fizz Executives">
                ...
                <Person 
                    title="VP Academic" 
                    name="Esther Lin and Dominic Shillingford"
                    email="vpacademic"
                ...
                <Person 
                    title="VP Events" 
                    name="Richard Echegaray, Tiffany Quon and Sydney Seraphim"
                    email="vpevents"
                ...
                <Person 
                    ...
                    name="Julia Rosenrauch and Maria Sottile"
                    email="bos"
                ...
                <Person 
                    ...
                    name="Michael Miller and Ryley Simpson"
                    email="penthouse"
                ...
                <Person 
                    ...
                    name="Maria Phelan and Maria Sottile"
                    email="eweek"

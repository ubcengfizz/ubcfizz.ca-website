    ...
    return (
        <div className="container">
            ...
            <div className="text">
                ...
                <Person 
                    title="President" 
                    name="Andrew Cote and Justin Kang"
                    email="president"
                ...
                <Person 
                    title="VP Academic" 
                    name="Esther Lin and Daniel Schultz"
                    email="vpacademic"
                ...
                <Person 
                    title="VP Events" 
                    name="Tiffany Quon and Sydney Seraphim"
                    email="vpevents"
                ...
                <Person 
                    ...
                    name="Richard Echegaray / Nicolas Navarre and Jeremy Voldeng / Esther Lin"
                ...
                <Person 
                    title="IT Manager" 
                    name="Dominic Shillingford and Chris Wilson"
                    email="compadmin"
                ...
                <Person 
                    ...
                    name="Robert Drinnan and James Park"
                    email="bos"
                ...
                <Person 
                    ...
                    name="Maria Sottile and Chris Wilson"
                    email="sports"
                ...
                <Person 
                    ...
                    name="Michael Miller and Ryan Schmidt"
                    email="penthouse"

    ...
    render() {
        return (
            <PageTemplate shortTitle="Survive" fullTitle="Survival Guide">
                <div className="cd"><h2><a name="TOC-Intro"></a>
    Intro</h2>
<div className="content"><span lang="EN-CA">Hey! We’ve got some news for you.</span></div>
<div className="content"><span lang="EN-CA">The <b><i>good</i></b> news is you have made it into
        the Engineering Physics program, one of the most challenging programs here at
        UBC.</span></div>
<div className="content"><span lang="EN-CA">The <b><i>bad</i></b> news is you have made it into
        the Engineering Physics program, one of the most challenging programs here at
        UBC.</span></div>
<div className="content"><span lang="EN-CA">Wait. Hold off on the panic attack. And
        breathe.</span></div>
<div className="content"><span lang="EN-CA">The Engineering Physics program has a
...
<div className="content"><span lang="EN-CA">This survival guide is full of explanations
...
<div className="content"><span lang="EN-CA">Read the rest of this guide and slot it
...
<div className="content"><span lang="EN-CA">&nbsp;“Engineering Physics
        is an Honours Physics degree with an engineering component tacked on at the
        end”</span></div>
<h4><a name="TOC-1"></a><br/></h4><span ><b>The Soccer Analogy</b></span> &nbsp;<div>
    ...
    <h3><a name="TOC-What-can-I-do-with-an-Engineering-Physics-degree-"></a>What can I do with an
        Engineering
        Physics degree? </h3>
    &nbsp;<br/>
...
<div className="content">
    ...
    <div>
        <div>
            ...
            <div><br/>
                "You must be an engineer," says the balloonist.&nbsp;</div>
            <div><br/>
                "I am," replies the man. "How did you know?"&nbsp;</div>
            <div><br/>
                "Well," says the balloonist, "everything you have told me is technically correct, but it's
                of no
                use to anyone." <br/>
                The man below says, "You must be in management."&nbsp;</div>
            <div><br/>
                "I am," replies the balloonist, "but how did you know?"&nbsp;</div>
            <div><br/>
                "Well," says the man, "you don't know where you are, or where you're going, but you expect
                me to
                be able to help. You're in the same position you were before we met, but now it's my fault."
                <br/>
                &nbsp;<br/><b><i>
            ...
            <div><br/>
                “What’s wrong?” the cop asked.&nbsp;</div>
            <div><br/>
                “I’ve lost my electron!” the hydrogen atom exclaimed.&nbsp;</div>
            <div><br/>
                “Are you sure?” the cop asked doubtfully.&nbsp;</div>
            <div><br/>
                “I’m positive,” the hydrogen atom sighed. <br/>
                &nbsp;<br/>
            </div>
        </div>
    </div>
